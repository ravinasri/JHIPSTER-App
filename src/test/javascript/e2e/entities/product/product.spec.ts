...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('jhipsterSampleApp.product.home.title');
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('jhipsterSampleApp.product.home.createOrEditLabel');
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([productUpdatePage.setRegionNameInput('regionName')]);

    expect(await productUpdatePage.getRegionNameInput()).to.eq('regionName', 'Expected RegionName value to be equals to regionName');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApp.product.delete.question');
