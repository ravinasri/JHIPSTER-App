...
describe('Author e2e test', () => {
  ...
  it('should load Authors', async () => {
    ...
    expect(await authorComponentsPage.getTitle()).to.eq('jhipsterSampleApp.author.home.title');
  ...
  it('should load create Author page', async () => {
    ...
    expect(await authorUpdatePage.getPageTitle()).to.eq('jhipsterSampleApp.author.home.createOrEditLabel');
  ...
  it('should delete last Author', async () => {
    ...
    expect(await authorDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApp.author.delete.question');
