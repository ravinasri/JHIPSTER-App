...
import com.mycompany.myapp.JhipsterSampleApp;
...
public class BoardResourceIT {
    ...
    private static final String DEFAULT_NOTICE_LIST = "AAAAAAAAAA";
    private static final String UPDATED_NOTICE_LIST = "BBBBBBBBBB";
    ...
    public static Board createEntity(EntityManager em) {
        Board board = new Board()
            .title(DEFAULT_TITLE)
            .noticeList(DEFAULT_NOTICE_LIST);
        return board;
    }
    /**
    ...
    public static Board createUpdatedEntity(EntityManager em) {
        Board board = new Board()
            .title(UPDATED_TITLE)
            .noticeList(UPDATED_NOTICE_LIST);
        return board;
    }
    ...
    public void createBoard() throws Exception {
        ...
        assertThat(testBoard.getNoticeList()).isEqualTo(DEFAULT_NOTICE_LIST);
    }
    ...
    public void getAllBoards() throws Exception {
        ...
        restBoardMockMvc.perform(get("/api/boards?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].noticeList").value(hasItem(DEFAULT_NOTICE_LIST)));
    }
    ...
    public void getBoard() throws Exception {
        ...
        restBoardMockMvc.perform(get("/api/boards/{id}", board.getId()))
            ...
            .andExpect(jsonPath("$.noticeList").value(DEFAULT_NOTICE_LIST));
    }
    @Test
    @Transactional
    ...
    public void updateBoard() throws Exception {
        ...
        assertThat(testBoard.getNoticeList()).isEqualTo(UPDATED_NOTICE_LIST);
    }
